...
class OlfactometerTests(unittest.TestCase):
    ...
    def test_model(self):
        ...
        stimuli_config = [
            OlfactometerChannelConfig(
                channel_index=HarpOlfactometerChannel.Channel0, odorant="Banana", odorant_dilution=0.1
            ),
            OlfactometerChannelConfig(
                channel_index=HarpOlfactometerChannel.Channel1, odorant="Banana", odorant_dilution=0.1
            ),
            OlfactometerChannelConfig(
                channel_index=HarpOlfactometerChannel.Channel2, odorant="Banana", odorant_dilution=0.1
            ),
        ]
