...
$outputPath = (Join-Path -Path "./scripts" -ChildPath "watchdog.exe") 
...
$taskTriggerStartup = New-ScheduledTaskTrigger -AtStartup -RandomDelay 00:00:30
$taskTriggerLogOn = New-ScheduledTaskTrigger -AtLogOn -RandomDelay 00:00:30
